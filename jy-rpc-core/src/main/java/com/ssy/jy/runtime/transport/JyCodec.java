...
public class JyCodec {
    ...
    static {
        ALL_PACKET_CLASS.put(Packet.Command.REQUEST_COMMAND, RpcRequestPacket.class);
        ALL_PACKET_CLASS.put(Packet.Command.REQUEST_RESPONSE_COMMAND, RpcResponsePacket.class);
    }
